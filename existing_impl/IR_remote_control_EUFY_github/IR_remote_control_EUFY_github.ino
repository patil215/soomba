...
const char* ssid = "HackMIT";                              // SSID
const char* password = "onatrip!";                   // Password
char auth[] = "30fd4d20856548609b262415858256c5";                               // Token for Esp8266
const char* OTAName = "blah";                       // OTA name
const char* OTAPassword = "blahbini";                    // OTA Password

// Prepare IR LED to be used
#define IR_LED 4                // ESP8266 GPIO pin to use for blaster (4 is D2 on nodeMCU devBoard)
#define IR_RECV 13               // ESP8266 GPIO pin to use for reciever (5 is D1 on nodeMCU devBoard)
